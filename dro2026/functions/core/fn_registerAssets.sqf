...
// FPV airframes. Their native impact logic is preferred; no injected universal warhead.
...
// Long-range airframes. fp1_base_F is intentionally not registered as a flying vehicle.
...
// Ground launchers are separate from airframes. Ammo is resolved from weapon -> magazine -> ammo.
...
{["LAUNCHER_FP2_GUER", _x] call _registerVehicle} forEach ["FRTZ_FP2_Launcher"];
{["LAUNCHER_BM35_GUER", _x] call _registerVehicle} forEach ["KBA_BM35_Launcher"];
...
// ISR by side and tier.
{["PLAYER_ISR_UAV", _x, true] call _registerVehicle} forEach [
    "B_UAV_01_F", "B_UAV_02_dynamicLoadout_F", "rksla3_uav_rq7shadow_01_blufor", "HE_MQ4A_Blufor",
    "O_UAV_01_F", "O_UAV_02_dynamicLoadout_F", "RUS_VKS_forpostru",
    "I_UAV_01_F", "I_UAV_02_dynamicLoadout_F"
];
