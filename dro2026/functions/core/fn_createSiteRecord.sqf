...
private _positionATL = [_position param [0,0,[0]],_position param [1,0,[0]],_position param [2,0,[0]]];
...
private _networkNodeId = switch true do {
    ...
    case (_type == "BALLISTIC_MISSILE_SITE"): {"NODE_BALLISTIC_01"};
    case (_type == "FARP"): {"NODE_FARP_01"};
    case (_type == "FRIENDLY_FARP"): {"NODE_FRIENDLY_FARP"};
...
private _record = createHashMapFromArray [
    ...
    ["stockHealth",1],["lastAppliedStockHealth",1],["physicalState",if (count _objects > 0) then {"ACTIVE"} else {"VIRTUAL"}],
