...
switch _poolKey do {
    ...
    case "LOGISTICS_POOL": {
        _role in ["LOGISTICS_AMMO","LOGISTICS_FUEL","LOGISTICS_REPAIR","LOGISTICS_GENERAL","TRANSPORT_CARGO","TRANSPORT_PERSONNEL"]
    };
    case "CONVOY_CARGO_POOL": {
        _role in ["LOGISTICS_AMMO","LOGISTICS_FUEL","LOGISTICS_REPAIR","LOGISTICS_GENERAL","TRANSPORT_CARGO","TRANSPORT_PERSONNEL","APC","IFV"]
    };
