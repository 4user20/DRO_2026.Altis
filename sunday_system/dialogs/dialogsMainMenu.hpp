class sundayDialog {
	...
	class controls {		
		...
		{
			idc = 1300;
			text = "Сторона игрока"; //--- ToDo: Localize;
		...
		{
			idc = 1310;
			text = "Сторона противника"; //--- ToDo: Localize;
		...
		{
			idc = 1320;
			text = "Гражданская фракция"; //--- ToDo: Localize;
		...
		class InfoGroup: RscControlsGroup {
			...
			class Controls {			
				...
				{
					idc = 1142;
					text = "DRO 2026 автоматически создаёт современную одиночную операцию: разведку, логистику, артиллерию, РЭБ, ПВО, конвои и беспилотные системы.\n\nНажмите «НАЧАТЬ» для полностью случайного сценария или настройте стороны, район, время и сложность. Типы задач можно отфильтровать на странице современного генератора.";
					x = "3 * pixelGridNoUIScale * pixelW";
		...
		class ScenarioGroup: RscControlsGroup {
			...
			class Controls {				
				...
				class AOSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "При включении генератор добавит до трёх соседних районов, формируя более крупную операционную зону.";
						};
				...
				class AISkillSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Обычный режим заметно снижает точность AI, сохраняя тактические навыки. Сложный повышает точность. Реализм использует настройки сложности Arma без дополнительных изменений.";			
						};
					};		
				};
				...
				{
					idc = 2040;
					text = "Множитель сил противника: x1.0";
					x = "1 * pixelGridNoUIScale * pixelW";
					...
					sizeEx = "((pixelH * (pixelGridNoUIScale) * 2) * 1.25) * 0.5";	
					font = "PuristaMedium";
					tooltip = "Позволяет настроить общий масштаб сил противника.";
				};
				...
				class MinesSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Разрешить генерацию минных полей или полностью отключить их.";
						};
					};		
				};
				class CivsSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Разрешить присутствие гражданских или полностью отключить их.";
						};
					};		
				};
				class StealthSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Включает учёт скрытности группы. Случайный режим обычно активирует его только вечером или ночью.";
						};
					};		
				};
				class ReviveSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Настройте время до окончательной гибели или отключите встроенную систему оживления.";
						};
					};		
				};
				class DynSimSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Динамическая симуляция снижает нагрузку, усыпляя второстепенные дальние группы. Колонны, артиллерия и активные беспилотники DRO 2026 остаются в работе.";
						};
					};		
				};
			};
				...
				class TimeSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Выберите время начала операции.";
						};
					};		
				};
				class WeatherSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Выберите погоду в начале операции.";
						};
					};		
				};
				class droAIBG: sundayText {
				...
				class AnimalsSwitchButton: RscControlsGroupNoScrollbars {
					...
					class Controls {
						...
						class SwitchButton: sundaySelButton {
							...
							tooltip = "Включить или отключить животных в окружающей среде.";
						};
					};		
				};				
			};
		...
		class ObjectivesGroup: RscControlsGroup {
			...
			class Controls {
				...
				{
					idc = 4020;
					text = "Современный генератор задач";
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "4 * pixelGridNoUIScale * pixelH";	
					w = "24 * pixelGridNoUIScale * pixelW";	
					h = "1.5 * pixelGridNoUIScale * pixelH";
				...
				{
					idc = 4021;			
					text = "Выберите предпочтительные направления операции. Генератор учитывает район, доступную технику и уже созданные задачи; без выбора используется полный случайный набор.";
					x = "1 * pixelGridNoUIScale * pixelW";
		...
		class AddFactionsGroup: RscControlsGroup {
			...
			class Controls {		
				...
				{
					idc = 3712;			
					text = "Здесь можно добавить дополнительные фракции к выбранной стороне. Их пехота и техника войдут в общий пул процедурной генерации."; //--- ToDo: Localize;
					x = "1 * pixelGridNoUIScale * pixelW";
					y = "0 * pixelGridNoUIScale * pixelH";	
					w = "24 * pixelGridNoUIScale * pixelW";	
