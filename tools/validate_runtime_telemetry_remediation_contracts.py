...
check('registry-wide quarantine','keys DRO2026_assetRegistry' in sanitize and 'RUNTIME_CLASS_QUARANTINED' in sanitize,'all downstream materializers inherit the blocklist')
check('mp header matches roles','maxPlayers = 8;' in header,'mission declares eight available roles')
